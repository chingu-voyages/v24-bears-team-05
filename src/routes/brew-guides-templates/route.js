module.exports = {
    ...
    data: async ({ request }) => {
        const guides = {
            chemex: {
                name: "Chemex Guide",
                qualities: 'Clean Body | Perfect For Two People | Great For Bright Notes',
                ...
                steps: [
                  {
                    id: 1,
                    img: '/images/chemex1.jpg',
                    title: '1. Prep Filter',
                    step: 'Unfold the filter with the three-fold side facing the spout. This is important to prevent the filter from collapsing into the spout when it gets wet.'
                  },
                  {
                    id: 2,
                    img: '/images/chemex2.jpg',
                    title: '2. Rinse',
                    step: 'Rinse the filter with plenty of hot water to help “seal” it against the glass and remove the papery taste — it also preheats your Chemex. Discard this rinse water (magically, you don’t actually need to take out the filter to pour out your water) and set up your brewer on a kitchen scale.'
                  },
                  {
                    id: 3,
                    img: '/images/chemex3.jpg',
                    title: '3. Add Grounds',
                    step: 'pour an initial amount of 90g of water and let bloom for 40 secs. Follow that by pouring the rest of the water'
                  },
                  {
                    id: 4,
                    img: '/images/chemex4.jpg',
            ...
            aeropress: {
                ...
                description: 'Aeropress. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Donec elementum ligula eu sapien consequat eleifend. Donec nec dolor erat, condimentum sagittis sem. Praesent porttitor porttitor risus, dapibus rutrum ipsum gravida et. Integer lectus',
                steps: [
                  {
                    id: 1,
                    img: '/images/chemex1.jpg',
            ...
            pourover: {
                ...
                description: 'Pour over. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit',
                steps: [
                  {
                    id: 1,
                    img: '/images/chemex1.jpg',
